...
class RentAdvanceInput extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return TextFormField(
      initialValue: flatCreateState.advancePriceInCents !=
              FlatModel.emptyFlat.advancePriceInCents
          ? (flatCreateState.advancePriceInCents ~/ 100).toString()
          : null,
      onSaved: onSaved,
      ...
      decoration: InputDecoration(
        hintText: AppLocalizations.of(context)!.step2RentAdvanceHintText,
