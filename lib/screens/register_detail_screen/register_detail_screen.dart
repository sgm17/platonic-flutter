...
class RegisterDetailScreenState extends ConsumerState<RegisterDetailScreen> {
  ...
  Future<void> toggleFinishRegister() async {
    if (formKey.currentState!.validate()) {
      ...
      final userRegisterDetailState = ref.read(userRegisterDetailProvider);

      // Print userRegisterDetailState
      print(userRegisterDetailState);

      // Register user in the backend server
      await ref.read(userProvider.notifier).userRegisterDetailInBackend();
